        ...
        <div className="tw-space-y-6">
          ...
          <div className="tw-bg-white tw-p-4 tw-rounded-lg tw-border">
            ...
            <div className="tw-space-y-3">
              <button han className="tw-w-full tw-transition tw-bg-yellow-500 hover:tw-bg-yellow-600 tw-text-white tw-font-bold tw-py-3 tw-rounded-lg tw-cursor-pointer" onClick={() => { navigate('/cart') }}>
                Add to Cart
              </button>
