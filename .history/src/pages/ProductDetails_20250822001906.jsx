...
const [user, setUser] = useState(null);
  ...
  setUser(getUser())
    ...
    const handleAddToCart = () => {
      if(user){
        userInteraction({user:{...user,cart:[...user.cart,product]}})
        navigate("/cart");
        ...
        <div className="tw-space-y-6">
          ...
          <div className="tw-bg-white tw-p-4 tw-rounded-lg tw-border">
            ...
            <div className="tw-space-y-3">
              <button  className="tw-w-full tw-transition tw-bg-yellow-500 hover:tw-bg-yellow-600 tw-text-white tw-font-bold tw-py-3 tw-rounded-lg tw-cursor-pointer" onClick={handleAddToCart}>
                Add to Cart
              </button>
