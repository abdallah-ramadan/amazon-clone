      ...
      <div className="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-8">
        ...
        <div className="tw-space-y-6">
          ...
          <div className="tw-bg-white tw-p-4 tw-rounded-lg tw-border">
            ...
            <button onC className="tw-w-full tw-mt-3 tw-bg-red-500 tw-transition tw-text-white hover:tw-bg-red-600 tw-border tw-rounded-lg tw-py-2 tw-border-gray-300 tw-cursor-pointer">
              Add to Favorite
            </button>
          </div>
