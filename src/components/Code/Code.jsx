...
export default function Code() {
  ...
  <h2 className='font-bold text-2xl text-center my-4 text-darkblue'>Code</h2>
  ...
  <div className="relative z-0 w-full mb-5 group">
      ...
      <label htmlFor="phone" className="peer-focus:font-medium left-0 absolute text-sm text-darkblue duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Write the code</label>
  ...
  <button type="submit" className="bg-darkblue text-stone-300 hover:ring-4 focus:outline-none  focus:ring-lightblue hover:text-darkblue hover:bg-beige font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center hover:bg-stone-300 focus:ring-darkblue">
    {isLouding? <i className='fas fa-spinner fa-spin'></i>:"Send"}
    </button>
