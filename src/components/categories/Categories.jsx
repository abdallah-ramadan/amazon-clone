            ...
            <div className='card p-3 h-100'>
              ...
              <div className='card-body row'>
                {category.subcategories.map((ele) => {
                  return (
                    <div className='category-item col-6 d-flex flex-column justify-content-center align-items-center' key={ele.category} onClick={() => navigate(`/category/${ele.category}`)}>
