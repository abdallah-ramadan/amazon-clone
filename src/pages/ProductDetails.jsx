...
const ProductDetails = () => {
  ...
  return (
    <div className="tw-p-5 tw-min-h-screen">
        ...
        <div className="tw-space-y-6">
          ...
          <div className="tw-bg-white tw-p-4 tw-rounded-lg tw-border">
            ...
            <div className="tw-space-y-3">
              <button className="tw-w-full tw-transition tw-bg-yellow-500 hover:tw-bg-yellow-600 tw-text-white tw-font-bold tw-py-3 tw-rounded-lg tw-cursor-pointer" onClick={() => handelAddToCart(product)}>
                Add to Cart
              </button>
            ...
            <button className="tw-w-full tw-mt-3 tw-bg-red-500 tw-transition tw-text-white hover:tw-bg-red-600 tw-border tw-rounded-lg tw-py-2 tw-border-gray-300 tw-cursor-pointer" onClick={() => { dispatch(addToWishlist(product)); toast.success(`${product.title} Was Saved`) }}>
              Add to Favorite
            </button>
          </div>
      ...
      <hr className="border border-2 border-secondary my-5" />
