        ...
        <div >
            ...
            <div >
                <Carousel  data-bs-theme="dark" indicators={false}>
                    <Carousel.Item className='slider' style={{ height: "75vh" }}>
                        <img
            ...
            <div className="position-relative p-4 container mb-5 mt-2 bg-white ">
                ...
                <div ref={sliderRef} className="d-flex flex-row overflow-auto gap-4" style={{ scrollBehavior: "smooth" }}>
                    {productsData.map((product, index) => (
                        <div key={index} className="d-flex flex-column align-items-center flex-shrink-0" style={{cursor: "pointer"}} onClick={() => ``}>
